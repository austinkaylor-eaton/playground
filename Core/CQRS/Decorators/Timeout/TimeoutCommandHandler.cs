...
/// <remarks>
/// Initializes a new instance of the <see cref="TimeoutCommandHandler{TCommand, TResponse}"/> class.
/// </remarks>
/// <param name="inner">The inner command handler to decorate.</param>
public sealed class TimeoutCommandHandler<TCommand, TResponse>(ICommandHandler<TCommand, TResponse> inner)
